            ...
            <div class="row mb-2">
                <div class="col-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Record New Sale</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card" style="border-radius: 20px;">
                        <div class="card-header">
                            <h3>Record New Customer Sale</h3>
                        </div>
                        <div class="card-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="customer_id" value="{{ $clientId }}"
                                                        readonly>
                                                    <small class="text-muted">Auto-generated unique customer ID</small>
                                                    @error('customer_id')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('imei') is-invalid @enderror" 
                                                           id="imei" name="imei" value="{{ old('imei') }}" required>
                                                    @error('imei')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('phone_information') is-invalid @enderror" 
                                                              id="phone_information" name="phone_information" rows="3">{{ old('phone_information') }}</textarea>
                                                ...
                                                <div class="form-group">
                                                    <label for="phone_photo">Phone Photo</label>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('sale_status') is-invalid @enderror" 
                                                        ...
                                                        <option value="sold" {{ old('sale_status') == 'sold' ? 'selected' : '' }}>Sold</option>
                                                        <option value="returned" {{ old('sale_status') == 'returned' ? 'selected' : '' }}>Returned</option>
                                                        <option value="warranty_claim" {{ old('sale_status') == 'warranty_claim' ? 'selected' : '' }}>Warranty Claim</option>
