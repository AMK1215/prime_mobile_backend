...
<head>
    ...
    <title>Prime Mobile | Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <img src="{{ asset('assets/img/logo/logo.jpg') }}" alt="AdminLTE Logo"
                class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Prime Mobile</span>
            </a>
            <!-- Brand Logo -->
            <!-- Sidebar -->
            <div class="sidebar">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2025 <a href="">Prime Mobile</a>.</strong>
            All rights reserved.
